...
import group24.escaperoom.data.Types.ListPlayerRecordRequest;
import group24.escaperoom.data.Types.ListPlayerRecordResponse;
...
public class LeaderboardScreen extends MenuScreen {
  ...
  private void addEntry(PlayerRecord record) {
    // Username
    entries.add(new SmallLabel(record.username, "white"));
    // attempts
    entries.add(new SmallLabel(Integer.toString(record.attempts), "white"));
    // clears
    entries.add(new SmallLabel(Integer.toString(record.clears), "white"));
    // uniqueclears
    entries.add(new SmallLabel(Integer.toString(record.clearList.size), "white"));
    entries.row();
  }

  private void addHeader() {
    // Username
    entries.add(new SmallLabel("Username", "title"));
    // attempts
    entries.add(new SmallLabel("Attempts", "title"));
    // clears
    entries.add(new SmallLabel("Map Clears", "title"));
    // uniqueclears
    entries.add(new SmallLabel("Unique Clears", "title"));
    entries.row();
  }

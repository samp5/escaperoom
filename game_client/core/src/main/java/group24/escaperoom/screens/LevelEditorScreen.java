...
import group24.escaperoom.data.Grid.DrawableComparator;
...
import group24.escaperoom.ui.EditorUI.ItemHintMode;
...
import group24.escaperoom.ui.editorTools.MoveTool.SoloMoveTool;
...
public class LevelEditorScreen extends MapScreen {
  ...
  public void setPlayMode() {
    ...
    ScreenManager.instance().showScreen(new SinglePlayerGameScreen(new MapData(grid, metadata)));
  }
  ...
  public void reloadItems() {
    ...
    metadata.objectDirectory.ifPresent((uo) -> ObjectLoader.LoadUserObjects(uo));
   ...
   *
   * @see LevelEditorScreen#removeOverlayDrawable(Drawable)
   *
   ...
   *
   * @see LevelEditorScreen#addOverlayDrawable(Drawable)
   *
  ...
  private void registerEditBinds() {
    addListener(new InputListener(){
      ...
      public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
        ...
        movingItem = priorityItemAt((int) x, (int) y).map((i) -> new SoloMoveTool(i, LevelEditorScreen.this));

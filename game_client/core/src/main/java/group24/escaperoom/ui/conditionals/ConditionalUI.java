...
public class ConditionalUI extends Table implements HandlesMenuClose {
  ...
  private class ConditionalBlock extends Stack {
    ...
    private ConditionalBlock(Conditional cond) {
      ...
      label = cond.getType() == ConditionalType.EmptyConditional ? new SmallLabel("<empty>", "bubble", 0.65f)
          : new SmallLabel(cond.getName(), "bubble", 0.65f);
  ...
  private class ConditionalBlockSource extends DragAndDrop.Source {
    ...
    public Payload dragStart(InputEvent event, float x, float y, int pointer) {
      ...
      SmallLabel valid = new SmallLabel(source.val.getName(), "bubble", 0.65f);
      valid.setColor(0.75f, 1, 0.75f, 0.5f);

      SmallLabel invalid = new SmallLabel(source.val.getName(), "bubble", 0.65f);
  ...
  private class ConditionalSource extends DragAndDrop.Source {
    ...
    public Payload dragStart(InputEvent event, float x, float y, int pointer) {
      ...
      SmallLabel valid = new SmallLabel(c.getName(), "bubble", 0.65f);
      valid.setColor(0.75f, 1, 0.75f, 0.5f);

      SmallLabel invalid = new SmallLabel(c.getName(), "bubble", 0.65f);
      invalid.setColor(1, 0.75f, 0.75f, 0.5f);
  ...
  public ConditionalUI(ConditionalProperty conditionalProperty, Menu parentMenu) {
    ...
    parent = parentMenu;
    editor = (LevelEditorScreen)parent.getScreen();
